                    ...
                    <table class="table text-center">
                        ...
                        <tbody class="table-group-divider text-primary text-opacity-75 py-5">
                            @foreach ( $user as $users)
                                <tr>
                                    <td><a href="" class="text-decoration-none text-dark">{{ $users->name }}</a></td>
                                    <td>{{ $users->email }}</td>
                                    <td>{{ __('Zamboanga City') }}</td>
                                    <td>{{ __('09557815639') }}</td>
                                    <td>{{ $users->created_at->toDayDateTimeString() }}</td>
                                    <td>
                                        <button class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#exampleModalCenter{{ $users->id }}"><i class="fa-solid fa-eye"></i></button>
