                ...
                <form action="{{ route('add.education') }}" method="POST">
                    ...
                    <div class="row mb-3 mt-4">
                        ...
                        <div class="form-outline mb-2 text-start">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <select id="start_month" name="start_month" class="form-select form-select-lg @error('start_month') is-invalid @enderror" aria-label="Default select example" value="{{ old('start_month') }}">
                                ...
                                @enderror
                                <div class="col-lg-6">
                                    <select id="start_year" name="start_year" class="form-select form-select-lg @error('start_year') is-invalid @enderror" aria-label="Default select example" value="{{ old('start_year') }}">
                        ...
                        <div class="form-outline mb-2 text-start">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <select id="end_month" name="end_month" class="form-select form-select-lg @error('end_month') is-invalid @enderror" aria-label="Default select example" value="{{ old('end_month') }}">
                                        <option selected disabled>Month</option>
                                        <option value="{{ __('January') }}">{{ __('January') }}</option>
                                        <option value="{{ __('February') }}">{{ __('February') }}</option>
                                        <option value="{{ __('March') }}">{{ __('March') }}</option>
                                ...
                                @enderror
                                <div class="col-lg-6">
                                    <select id="end_year" name="end_year" class="form-select form-select-lg @error('end_year') is-invalid @enderror" aria-label="Default select example" value="{{ old('end_year') }}">
                                        <option selected disabled>Year</option>
                                        <option value="{{ __('2023') }}">{{ __('2023') }}</option>
                                        <option value="{{ __('2022') }}">{{ __('2022') }}</option>
                                        <option value="{{ __('2021') }}">{{ __('2021') }}</option>
